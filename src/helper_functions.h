...
/**
 * Computes particle weight based on the multivariate
 * Gaussian distribution
 * @param (sig_x, sig_y) standard deviations for x & y
 * @param (x_obs, y_obs) x and y coordinates of the landmark
 * @param (mu_x, mu_y) mean value for x & y
 */
